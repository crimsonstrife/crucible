<x-action-section>
    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                <p class="small mb-3 {{ $showingConfirmation ? 'fw-semibold' : '' }}">
                    @if ($showingConfirmation)
                ...
                @if ($showingConfirmation)
                    <div class="mb-3" style="max-width: 20rem;">
                        ...
                        <x-input id="code" type="text" name="code" class="mt-1" inputmode="numeric" autofocus autocomplete="one-time-code"
                            wire:model="code"
            ...
            @if ($showingRecoveryCodes)
                ...
                <div class="bg-auto border rounded p-3 mb-3 font-monospace small">
