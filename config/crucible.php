...
return [
    ...
    'git' => [
        ...
        // When true, git invocations are prefixed with `nice -n 19 ionice -c 3`
        // so push/pull workloads yield CPU and disk I/O to php-fpm under load.
        // Requires nice + ionice on PATH (standard on Ubuntu).
        'nice_wrap' => env('CRUCIBLE_GIT_NICE_WRAP', false),
    ],
    'lfs' => [
